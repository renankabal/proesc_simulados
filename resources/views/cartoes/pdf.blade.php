...
<style>
  ...
  .circle { display: inline-block; width: 18px; height: 18px; border: 1.5px solid #333; border-radius: 50%; line-height: 18px; font-size: 9pt; cursor: default; }
...
<p style="font-size:9pt;color:#555;margin-bottom:6px">
    Preencha completamente a bolinha correspondente à sua resposta:
</p>
...
<p class="instructions">
    Não rasgue, dobre ou amasse este cartão &bull; Use caneta azul ou preta &bull;
    Preencha completamente os círculos &bull; Tentativa {{ $cartao->tentativa }}
</p>
